...
import com.abel.app.b2b.adapters.FourDigitCardFormatWatcher;
import com.abel.app.b2b.adapters.Helper;
import com.abel.app.b2b.base.BaseFragment;
import com.abel.app.b2b.databinding.FragmentAddCreditcardBinding;
import com.abel.app.b2b.flexiicar.booking.Fragment_Finalize_Your_Rental;
import com.abel.app.b2b.flexiicar.booking.Fragment_Vehicles_FilterList;
...
import static com.abel.app.b2b.apicall.ApiEndPoint.ADDCARD;
...
public class Fragment_Add_credit_card_For_User extends BaseFragment
{
   ...
   // public static Context context;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        binding.backAddcreditcard.setOnClickListener(this);
        binding.txtDiscardAddCC.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.scanCreditcard:
                ...
                startActivity(i);
                break;
            case R.id.back_addcreditcard:

            case R.id.txtDiscardAddCC:
                NavHostFragment.findNavController(Fragment_Add_credit_card_For_User.this).popBackStack();
             /*   if(backTo == 1)
                {
