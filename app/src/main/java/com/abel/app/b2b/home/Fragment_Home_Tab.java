...
import com.abel.app.b2b.databinding.FragmentHomeBinding;
...
public class Fragment_Home_Tab extends BaseFragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
      ...
      //  getview.getCompanyLabel(view, companyLabel);
        ...
        new ApiService(getHomeImage, RequestType.POST,SPLASH,BASE_URL_LOGIN,header,params.getBasicDetail(getResources().getString(R.string.HomePageScreen)));
