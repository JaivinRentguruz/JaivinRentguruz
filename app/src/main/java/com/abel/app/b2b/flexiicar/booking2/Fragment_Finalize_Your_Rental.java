...
import com.abel.app.b2b.databinding.FragmentFinalizeYourRentalBinding;
import com.abel.app.b2b.databinding.ListAdditionalDriverBinding;
            ...
            handler.post(() -> {
                ...
                Log.d("TAG", "onSuccess: " + response);
                    ...
                    if (status)
                    {
                        ...
                        binding.layoutPayment.setClickable(true);
                        JSONObject data = responseJSON.getJSONObject("Data");
        ...
        switch (v.getId()){
            ...
            case R.id.layout_payment:
                if (reserversationSummary.Id == 0) {
                    ...
                    binding.layoutPayment.setClickable(false);
