        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    ContextThemeWrapper ctw = new ContextThemeWrapper( context, R.style.FullscreenTheme);
                    ...
                    alertDialogBuilder.setNegativeButton("Open report",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            File pdfFile = new File(Environment.getExternalStorageDirectory() +   "/Android/data/"
                                    + context.getPackageName()
                                    + "/Files" + downloadFileName);  // -> filename = maven.pdf
